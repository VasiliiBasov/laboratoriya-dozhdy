...
function Header({ portfolioTitle = '' }) {
  ...
  return (
    <header
      className={`site-header ${isScrolled ? 'scrolled' : ''} ${mobileMenuOpen ? 'mobile-open' : ''}`}
    >
      <div className="header-container">
        ...
        <div
          className={`portfolio-header-title ${isFullscreen && displayedTitle && !footerInView ? 'visible' : ''} ${titleFading || footerInView ? 'fade' : ''}`}
        >
        ...
        <div className="header-contacts">
          <a href="tel:+79995292065" className="phone-link">
            +7 (999) 529-20-65
          </a>
