...
const reviewsJsonLd = {
        ...
        review: [
            {
                ...
                reviewBody: 'Сделали автополив на 12 сотках за 4 дня. Работой доволен, всё работает чётко второй сезон.',
            ...
            },
            {
                ...
                reviewBody: 'Заказывали проектирование и монтаж. Ребята профессиональные, посоветовали оборудование под наш участок.',
                reviewRating: { '@type': 'Rating', ratingValue: '5' },
            },
            {
                '@type': 'Review',
                ...
                reviewBody: 'Сезонное обслуживание уже два года. Приезжают вовремя, проверяют систему, консервируют на зиму.',
    ...
    const sourcesJsonLd = {
        ...
        inLanguage: 'ru-RU',
        isBasedOn: [
            { '@type': 'TechArticle', name: 'Hunter Industries — техническая документация по автополиву', url: 'https://www.hunterindustries.com/' },
            { '@type': 'TechArticle', name: 'BRAND_NAME — каталог профессионального оборудования', url: 'https://www.' + BRAND_NAME.toLowerCase() + '.ru/' },
        ],
        citation: [
            { '@type': 'Organization', name: 'Ассоциация ландшафтных инженеров России', url: 'https://alir.ru/' },
            { '@type': 'Organization', name: 'СП 31.13330.2012 Водоснабжение. Наружные сети и сооружения' },
        ],
    };
    ...
    const internalLinksJsonLd = {
        ...
        '@type': 'ItemList',
        itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Услуги автополива', url: 'https://rain-lab.ru/services' },
            { '@type': 'ListItem', position: 2, name: 'Портфолио проектов', url: 'https://rain-lab.ru/portfolio' },
            ...
            { '@type': 'ListItem', position: 5, name: 'Политика конфиденциальности', url: 'https://rain-lab.ru/privacy' },
        ],
    };
        ...
        row: [
            {
                ...
                cell: [
                    ...
                    { '@type': 'TableCell', value: 'от 80 000 ₽' },
...
const HomePage = () => {
    ...
    const handleCta = (to) => { if (to) navigate(to); };
    ...
    const handleLoaded = () => {
        try {
            ...
            if (p && typeof p.catch === 'function') {
                p.catch(() => { /* autoplay заблокирован — игнор, юзер кликнет */ });
            }
        } catch (e) {
