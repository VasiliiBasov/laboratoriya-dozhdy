...
const servicesSections = [
  {
    ...
    description:
      'Проектирование, монтаж и обслуживание систем автоматического полива для участков любой сложности',
  },
  {
    id: 2,
    ...
    description:
      'Экономичная система точечной подачи воды непосредственно в корневую зону растений',
  },
  {
    id: 3,
    image: nozzleHunter,
    title: 'Дождевание',
    description:
      'Роторные и веерные спринклеры для равномерного орошения газонов и больших площадей',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description:
      'Готовое решение для парников и теплиц: стабильная влажность, экономия воды, минимум ручного труда',
  },
];
