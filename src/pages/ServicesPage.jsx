...
const faqItems = [
    {
        ...
        a: 'Стоимость рассчитывается индивидуально и зависит от площади участка, количества зон полива, типа оборудования и сложности коммуникаций. Ориентировочно — от 1 200 ₽ за сотку под ключ с оборудованием Hunter. Точную смету подготовим после выезда на замер.'
    },
    {
...
const servicesSections = [
    {
        ...
        description: 'Проектирование, монтаж и обслуживание систем автоматического полива для участков любой сложности'
    },
    {
        id: 2,
        image: dripPrettyDrop,
        title: 'Капельный полив',
        description: 'Экономичная система точечной подачи воды непосредственно в корневую зону растений'
    },
    {
        id: 3,
        image: nozzleHunter,
        title: 'Дождевание',
        description: 'Роторные и веерные спринклеры для равномерного орошения газонов и больших площадей'
    },
    {
        id: 4,
        image: dripTechnology,
        title: 'Устройство газона',
        description: 'Рулонный и посевной газон с подготовкой почвы и системой ухода'
    },
    {
        id: 5,
        image: pipesCutaway,
        title: 'Дренаж и ливневая канализация',
        description: 'Отвод грунтовых и поверхностных вод — защита участка от подтоплений'
    },
    {
        id: 6,
        image: dripBeds,
        title: 'Капельный полив для теплиц',
        description: 'Готовое решение для парников и теплиц: стабильная влажность, экономия воды, минимум ручного труда'
    },
];
...
const ServicesPage = ({ onTitleChange }) => {
    ...
    return (
        <div className="portfolio-scroll-container" ref={containerRef}>
            ...
            >
                <div className="portfolio-item-image">
                    <img src={dripBeds} alt="Часто задаваемые вопросы об автополиве" loading="lazy" decoding="async" />
                    <div className="portfolio-item-overlay" />
                </div>
                ...
                <div className="portfolio-content-center">
                    ...
                    <p className="portfolio-section-desc">
                        Ответы на самые частые вопросы о системах автоматического полива.
                    ...
                    <div className="portfolio-faq-list">
                        {faqItems.map((it, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className={`portfolio-faq-item ${isOpen ? 'open' : ''}`}
                                >
                                    <button
                                        type="button"
