...
const AboutPage = ({ onTitleChange }) => {
    ...
    return (
        <div className="portfolio-scroll-container" ref={containerRef}>
            <SeoHead
                title="О компании TheGreenStone"
                description="Команда инженеров и ландшафтных дизайнеров TheGreenStone. Более 200 проектов автополива в Санкт-Петербурге и Ленинградской области. Гарантия 5 лет."
                path="/about"
                h1="О компании TheGreenStone — Лаборатория дождя"
            />
