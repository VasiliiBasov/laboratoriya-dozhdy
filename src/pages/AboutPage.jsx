...
const aboutSections = [
  {
    ...
    title: 'О компании',
    description:
      'Более 10 лет создаём комфортные и ухоженные территории. Команда инженеров, ландшафтных дизайнеров и специалистов по автополиву.',
    features: [
      {
        title: 'Опыт',
  ...
  },
  {
    ...
    title: 'Наша миссия',
    description:
      'Делаем загородную жизнь комфортной — берём на себя все задачи по озеленению и автополиву, чтобы вы наслаждались результатом, а не работой.',
  },
  {
    id: 3,
    ...
    title: 'Наша команда',
    description:
      'Инженеры-проектировщики, ландшафтные архитекторы, монтажники с многолетним опытом. Каждый объект ведёт персональный менеджер.',
  },
  {
    id: 4,
    ...
    title: 'Наши ценности',
    description:
      'Качество, надёжность, прозрачность. Используем только сертифицированное оборудование ведущих мировых производителей.',
  },
];
  ...
  return (
    <div className="portfolio-scroll-container" ref={containerRef}>
      ...
      <div className="portfolio-indicator">
        ...
        <span className="indicator-total">{String(aboutSections.length).padStart(2, '0')}</span>
      </div>
    </div>
  );
};
