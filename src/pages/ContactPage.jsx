...
const ContactPage = ({ onTitleChange }) => {
  ...
  return (
    <div className="portfolio-scroll-container" ref={containerRef}>
      <SeoHead
        title="Контакты"
        description="Свяжитесь с Rain-Lab: телефон, WhatsApp, Telegram, MAX, e-mail. Санкт-Петербург и Ленинградская область. Отвечаем за 30 минут."
        path="/contact"
        h1="Контакты Rain-Lab — связаться с нами"
      />
      ...
      <div className="portfolio-indicator">
        ...
        <span className="indicator-total">{String(contactSections.length).padStart(2, '0')}</span>
      </div>
    </div>
  );
};
